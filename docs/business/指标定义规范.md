...
#### 年度预测达成率
- **hq_achievement_rate_annual** <!--impl:src/domain/headquarters.ts:21-28-->
  年度预测达成率 = 全省年累计实际 / 总公司年度目标

#### 月度累计预测达成率
- **hq_achievement_rate_monthly** <!--impl:src/domain/headquarters.ts:64-96-->
  月度累计达成率 = 全省月度累计实际 / 总公司月度累计目标
  - 月度累计目标 = 总公司年度目标 × (当前月份 / 12)

#### 季度累计预测达成率
- **hq_achievement_rate_quarterly** <!--impl:src/domain/headquarters.ts:102-109-->
  季度累计达成率 = 全省季度累计实际 / 总公司季度目标
  - 季度目标 = 总公司年度目标 × 0.25（简化：平均分配）

### 差距分析
- **hq_gap** <!--impl:src/domain/headquarters.ts:36-43-->
  差距值 = 实际完成值 - 总公司目标值
  - 正数：超额完成
  - 负数：未达标

### UI展示
- **分产品卡片**：显示各产品（车险、财产险、人身险、健康险、汇总）的总公司目标和当前达成率
